...
export const copy = {
  en: {
    ...
    sectorAlt: [
      ...
      "Shielded modules installed in the garage of a house at dusk, with a drone in the sky outside",
  ...
  de: {
    ...
    sectorAlt: [
      ...
      "Geschirmte Module in der Garage eines Wohnhauses in der Dämmerung, draußen eine Drohne am Himmel",
  ...
  ko: {
    ...
    sectorAlt: [
      ...
      "해질 무렵 주택 차고에 설치된 차폐 모듈과 바깥 하늘에 떠 있는 드론",
